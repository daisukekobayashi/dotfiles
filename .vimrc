...
if has('nvim')
  ...
  if g:os == "Windows" || g:msys == 1
    let g:python_host_prog=$WIN_HOME . "/.pve/python2.7.16/Scripts/python.exe"
    let g:python3_host_prog=$PYENV_ROOT . '/.pve/python3.7.3/Scripts/python.exe'
  else
    let g:python_host_prog=$PYENV_ROOT . '/versions/python2.7.16/bin/python'
    let g:python3_host_prog=$PYENV_ROOT . '/versions/python3.7.3/bin/python'
  endif
else
